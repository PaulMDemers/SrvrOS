...
static void print_help(void) {
    ...
    cli_puts("commands: ls cat write cp rm mkdir mv tap wc grep head stat ps kill which env pwd true false hello webd spin fpdemo desktop calcgui notesgui textedit imgedit posixdemo jsondemo inidemo linedemo sqlitedemo zlibdemo lua\n");
