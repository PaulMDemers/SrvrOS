...
enum gui_message_type {
    ...
    GUI_MSG_V2_EVENT_CONFIGURE = 120,
    GUI_MSG_V2_EVENT_FOCUS = 121,
    GUI_MSG_V2_EVENT_POINTER_MOVE = 122,
    GUI_MSG_V2_EVENT_POINTER_BUTTON = 123,
    GUI_MSG_V2_EVENT_KEY_DOWN = 124,
};
