...
$(USER_UVDEMO): $(ZIG) $(USER_CRT0_OBJ) $(USER_UVDEMO_OBJ) $(UV_SRVROS_OBJ) $(USER_LIB_OBJ) userspace/app.ld
	mkdir -p $(dir $@)
	$(LD) $(USER_APP_LDFLAGS) $(USER_CRT0_OBJ) $(USER_UVDEMO_OBJ) $(UV_SRVROS_OBJ) $(USER_LIB_OBJ) -o $@

$(USER_LIBUVDEMO): $(ZIG) $(USER_CRT0_OBJ) $(USER_LIBUVDEMO_OBJ) $(UV_SRVROS_OBJ) $(USER_LIB_OBJ) userspace/app.ld
	mkdir -p $(dir $@)
	$(LD) $(USER_APP_LDFLAGS) $(USER_CRT0_OBJ) $(USER_LIBUVDEMO_OBJ) $(UV_SRVROS_OBJ) $(USER_LIB_OBJ) -o $@
