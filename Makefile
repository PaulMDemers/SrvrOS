...
$(USER_SH): $(ZIG) $(USER_CRT0_OBJ) $(USER_SH_OBJ) $(USER_LIB_OBJ) userspace/app.ld
	mkdir -p $(dir $@)
	$(LD) $(USER_APP_LDFLAGS) $(USER_CRT0_OBJ) $(USER_SH_OBJ) $(USER_LIB_OBJ) -o $@
