...
def build_script(rounds):
    ...
    lines.extend([
        ...
        "write /fat/r.txt rename-entry-ok\n",
        "mv /fat/r.txt /fat/renamed-entry-longer-than-before.txt\n",
        "cat /fat/renamed-entry-longer-than-before.txt\n",
        "mv /fat/renamed-entry-longer-than-before.txt /fat/r2.txt\n",
        "cat /fat/r2.txt\n",
        "rm /fat/r2.txt\n",
