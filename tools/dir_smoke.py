...
def main():
    parser = argparse.ArgumentParser(description="Verify srvros exFAT directory creation.")
    ...
    parser.add_argument("--line-wait", type=float, default=3)
    ...
    with tempfile.TemporaryDirectory(prefix="srvros-dir-") as temp_dir:
        disk = os.path.join(temp_dir, "srvros-dir.exfat")
        ...
        script = (
            "mkdir /fat/projects\n"
            "mkdir /fat/projects/src\n"
            "write /fat/projects/src/readme.txt nested-ok\n"
            "mv /fat/projects/src/readme.txt /fat/projects/src/renamed.txt\n"
            "cat /fat/projects/src/renamed.txt\n"
            "rmdir /fat/projects/src\n"
            "rm /fat/projects/src/renamed.txt\n"
            "rmdir /fat/projects/src\n"
            "mkdir /fat/projects/empty\n"
            "mv /fat/projects/empty /fat/projects/gone\n"
            "rmdir /fat/projects/gone\n"
            "stat /fat/projects\n"
            "ls /fat/projects\n"
            "ls -l /fat\n"
            "exit\n"
    ...
    expected = [
        ...
        "/fat/projects: 0 bytes directory",
        "nested-ok",
        "rmdir: failed: /fat/projects/src",
        "projects/",
        "exfat-check:",
        "errors=0 ok",
    ]
    ...
    if has_fatal_exception(text):
        print("dir-smoke: fatal exception detected", file=sys.stderr)
        return 2
    if missing:
        print("dir-smoke: missing markers:", file=sys.stderr)
